...
single_inputs = dict(
    ...
    run = dict(
        ...
        job_name = "blocked_ctprime_yaw_h_kjm",
        # if not provided, default_inputs will be used
        n_hrs = 24,
    )
)

varied_inputs = dict(turb = dict(cT = [-3.0,-2.0,-1.0, 0.5, 1, 1.5, 2.0, 2.5, 3, 3.5, 4], yaw = [10, 20, 30, 40, 50, 60, 70, 80, 90]))  # below and above the Betz limit
