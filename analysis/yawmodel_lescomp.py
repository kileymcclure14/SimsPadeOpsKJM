...
ctprimes  = [0.5, 1, 1.5]
cp_les = np.load('cp_10deg_35_mini.npy')
...
plt.plot(ctprimes, cp_ctprime[0:3], linestyle = '-', label = 'Ct Prime Input', color = 'blue')
...
plt.savefig('cp_lescomp_10_35_mini.png', bbox_inches='tight', dpi=300)