...
cp_les = np.load('cp_0deg_35.npy')
cp_ctprime = np.load('cp_0deg_35_model_new.npy')
cp_ct= np.load('cp_0deg_35_ct_test.npy')
...
plt.ylabel('Cp')
plt.title('LES and Model Output Compare (35% Blockage, 0 deg Yaw)')
plt.legend(bbox_to_anchor=(1.05, 1), loc='upper left')
plt.savefig('cp_ct_lescomp_35.png', bbox_inches='tight', dpi=300)