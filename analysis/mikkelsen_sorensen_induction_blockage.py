...
plt.scatter(Ctprime_plot[1:16], cp_mblock[1:16], label = 'LES Unfiltered', color = 'black', marker = '^')
plt.scatter(Ctprime_plot[1:16], cp_mblock_cor[1:16], label = 'LES Filtered', color = 'red', marker = '^')
plt.ylim(-1,1)
plt.xlabel('Ct Prime')
