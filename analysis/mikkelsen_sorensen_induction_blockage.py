...
cp_prime1 = cp_les1*(V0_Vp1**2)
cp_prime2 = cp_les2*(V0_Vp2**2)
cp_prime3 = cp_les3*(V0_Vp3**2)
cp_prime4 = cp_les4*(V0_Vp4**2)
cp_prime5 = cp_les5*(V0_Vp5**2)
cp_prime6 = cp_les6*(V0_Vp6**2)
cp_prime7 = cp_les7*(V0_Vp7**2)
cp_prime8 = cp_les8*(V0_Vp8**2)
cp_prime9 = cp_les9*(V0_Vp9**2)
cp_prime10 = cp_les10*(V0_Vp10**2)
cp_prime11 = cp_les11*(V0_Vp11**2)
cp_prime12 = cp_les12*(V0_Vp12**2)
cp_prime13 = cp_les13*(V0_Vp13**2)
cp_prime14 = cp_les14*(V0_Vp14**2)
cp_prime15 = cp_les15*(V0_Vp15**2)
cp_prime16 = cp_les16*(V0_Vp16**2)
cp_prime17 = cp_les17*(V0_Vp17**2)

#Unblocked, Correction
cp_prime1_cor = cp_les1_cor*(V0_Vp1_cor**2)
cp_prime2_cor = cp_les2_cor*(V0_Vp2_cor**2)
cp_prime3_cor = cp_les3_cor*(V0_Vp3_cor**2)
cp_prime4_cor = cp_les4_cor*(V0_Vp4_cor**2)
cp_prime5_cor = cp_les5_cor*(V0_Vp5_cor**2)
cp_prime6_cor = cp_les6_cor*(V0_Vp6_cor**2)
cp_prime7_cor = cp_les7_cor*(V0_Vp7_cor**2)
cp_prime8_cor = cp_les8_cor*(V0_Vp8_cor**2)
cp_prime9_cor = cp_les9_cor*(V0_Vp9_cor**2)
cp_prime10_cor = cp_les10_cor*(V0_Vp10_cor**2)
cp_prime11_cor = cp_les11_cor*(V0_Vp11_cor**2)
cp_prime12_cor = cp_les12_cor*(V0_Vp12_cor**2)
cp_prime13_cor = cp_les13_cor*(V0_Vp13_cor**2)
cp_prime14_cor = cp_les14_cor*(V0_Vp14_cor**2)
cp_prime15_cor = cp_les15_cor*(V0_Vp15_cor**2)
cp_prime16_cor = cp_les16_cor*(V0_Vp16_cor**2)
cp_prime17_cor = cp_les17_cor*(V0_Vp17_cor**2)