...
U8_cor = 1-a_les8_cor
U9_cor = 1
U10_cor = 1-a_les10_cor
U11_cor = 1-a_les11_cor
U12_cor = 1-a_les12_cor
U13_cor = 1-a_les13_cor
U14_cor = 1-a_les14_cor
U15_cor = 1-a_les15_cor
U16_cor = 1-a_les16_cor
U17_cor = 1-a_les17_cor
...
V0_Vp1 = 1/(U1 + (ct_les1/(4*U1)))
V0_Vp2 = 1/(U2 + (ct_les2/(4*U2)))
V0_Vp3 = 1/(U3 + (ct_les3/(4*U3)))
V0_Vp4 = 1/(U4 + (ct_les4/(4*U4)))
V0_Vp5 = 1/(U5 + (ct_les5/(4*U5)))
V0_Vp6 = 1/(U6 + (ct_les6/(4*U6)))
V0_Vp7 = 1/(U7 + (ct_les7/(4*U7)))
V0_Vp8 = 1/(U8 + (ct_les8/(4*U8)))
V0_Vp9 = 1/(U9 + (ct_les9/(4*U9)))
V0_Vp10 = 1/(U10 + (ct_les10/(4*U10)))
V0_Vp11 = 1/(U11 + (ct_les11/(4*U11)))
V0_Vp12 = 1/(U12 + (ct_les12/(4*U12)))
V0_Vp13 = 1/(U13 + (ct_les13/(4*U13)))
V0_Vp14 = 1/(U14 + (ct_les14/(4*U14)))
V0_Vp15 = 1/(U15 + (ct_les15/(4*U15)))
V0_Vp16 = 1/(U16 + (ct_les16/(4*U16)))
V0_Vp17 = 1/(U17 + (ct_les17/(4*U17)))

#Unblocked, Corrected
V0_Vp1_cor = 1/(U1_cor + (ct_les1_cor/(4*U1_cor)))
V0_Vp2_cor = 1/(U2_cor + (ct_les2_cor/(4*U2_cor)))
V0_Vp3_cor = 1/(U3_cor + (ct_les3_cor/(4*U3_cor)))
V0_Vp4_cor = 1/(U4_cor + (ct_les4_cor/(4*U4_cor)))
V0_Vp5_cor = 1/(U5_cor + (ct_les5_cor/(4*U5_cor)))
V0_Vp6_cor = 1/(U6_cor + (ct_les6_cor/(4*U6_cor)))
V0_Vp7_cor = 1/(U7_cor + (ct_les7_cor/(4*U7_cor)))
V0_Vp8_cor = 1/(U8_cor + (ct_les8_cor/(4*U8_cor)))
V0_Vp9_cor = 1/(U9_cor + (ct_les9_cor/(4*U9_cor)))
V0_Vp10_cor = 1/(U10_cor + (ct_les10_cor/(4*U10_cor)))
V0_Vp11_cor = 1/(U11_cor + (ct_les11_cor/(4*U11_cor)))
V0_Vp12_cor = 1/(U12_cor + (ct_les12_cor/(4*U12_cor)))
V0_Vp13_cor = 1/(U13_cor + (ct_les13_cor/(4*U13_cor)))
V0_Vp14_cor = 1/(U14_cor + (ct_les14_cor/(4*U14_cor)))
V0_Vp15_cor = 1/(U15_cor + (ct_les15_cor/(4*U15_cor)))
V0_Vp16_cor = 1/(U16_cor + (ct_les16_cor/(4*U16_cor)))
V0_Vp17_cor = 1/(U17_cor + (ct_les17_cor/(4*U17_cor)))
...
#Unblocked, No Correction
cp_prime1 = cp_les1*(V0_Vp1**3)
cp_prime2 = cp_les2*(V0_Vp2**3)
cp_prime3 = cp_les3*(V0_Vp3**3)
cp_prime4 = cp_les4*(V0_Vp4**3)
cp_prime5 = cp_les5*(V0_Vp5**3)
cp_prime6 = cp_les6*(V0_Vp6**3)
cp_prime7 = cp_les7*(V0_Vp7**3)
cp_prime8 = cp_les8*(V0_Vp8**3)
cp_prime9 = cp_les9*(V0_Vp9**3)
cp_prime10 = cp_les10*(V0_Vp10**3)
cp_prime11 = cp_les11*(V0_Vp11**3)
cp_prime12 = cp_les12*(V0_Vp12**3)
cp_prime13 = cp_les13*(V0_Vp13**3)
cp_prime14 = cp_les14*(V0_Vp14**3)
cp_prime15 = cp_les15*(V0_Vp15**3)
cp_prime16 = cp_les16*(V0_Vp16**3)
cp_prime17 = cp_les17*(V0_Vp17**3)

#Unblocked, Correction
cp_prime1_cor = cp_les1_cor*(V0_Vp1_cor**3)
cp_prime2_cor = cp_les2_cor*(V0_Vp2_cor**3)
cp_prime3_cor = cp_les3_cor*(V0_Vp3_cor**3)
cp_prime4_cor = cp_les4_cor*(V0_Vp4_cor**3)
cp_prime5_cor = cp_les5_cor*(V0_Vp5_cor**3)
cp_prime6_cor = cp_les6_cor*(V0_Vp6_cor**3)
cp_prime7_cor = cp_les7_cor*(V0_Vp7_cor**3)
cp_prime8_cor = cp_les8_cor*(V0_Vp8_cor**3)
cp_prime9_cor = cp_les9_cor*(V0_Vp9_cor**3)
cp_prime10_cor = cp_les10_cor*(V0_Vp10_cor**3)
cp_prime11_cor = cp_les11_cor*(V0_Vp11_cor**3)
cp_prime12_cor = cp_les12_cor*(V0_Vp12_cor**3)
cp_prime13_cor = cp_les13_cor*(V0_Vp13_cor**3)
cp_prime14_cor = cp_les14_cor*(V0_Vp14_cor**3)
cp_prime15_cor = cp_les15_cor*(V0_Vp15_cor**3)
cp_prime16_cor = cp_les16_cor*(V0_Vp16_cor**3)
cp_prime17_cor = cp_les17_cor*(V0_Vp17_cor**3)
...
#Unblocked, No Correction
ct_prime1 = ct_les1*(V0_Vp1**2)
ct_prime2 = ct_les2*(V0_Vp2**2)
ct_prime3 = ct_les3*(V0_Vp3**2)
ct_prime4 = ct_les4*(V0_Vp4**2)
ct_prime5 = ct_les5*(V0_Vp5**2)
ct_prime6 = ct_les6*(V0_Vp6**2)
ct_prime7 = ct_les7*(V0_Vp7**2)
ct_prime8 = ct_les8*(V0_Vp8**2)
ct_prime9 = ct_les9*(V0_Vp9**2)
ct_prime10 = ct_les10*(V0_Vp10**2)
ct_prime11 = ct_les11*(V0_Vp11**2)
ct_prime12 = ct_les12*(V0_Vp12**2)
ct_prime13 = ct_les13*(V0_Vp13**2)
ct_prime14 = ct_les14*(V0_Vp14**2)
ct_prime15 = ct_les15*(V0_Vp15**2)
ct_prime16 = ct_les16*(V0_Vp16**2)
ct_prime17 = ct_les17*(V0_Vp17**2)

#Unblocked, Correction
ct_prime1_cor = ct_les1_cor*(V0_Vp1_cor**2)
ct_prime2_cor = ct_les2_cor*(V0_Vp2_cor**2)
ct_prime3_cor = ct_les3_cor*(V0_Vp3_cor**2)
ct_prime4_cor = ct_les4_cor*(V0_Vp4_cor**2)
ct_prime5_cor = ct_les5_cor*(V0_Vp5_cor**2)
ct_prime6_cor = ct_les6_cor*(V0_Vp6_cor**2)
ct_prime7_cor = ct_les7_cor*(V0_Vp7_cor**2)
ct_prime8_cor = ct_les8_cor*(V0_Vp8_cor**2)
ct_prime9_cor = ct_les9_cor*(V0_Vp9_cor**2)
ct_prime10_cor = ct_les10_cor*(V0_Vp10_cor**2)
ct_prime11_cor = ct_les11_cor*(V0_Vp11_cor**2)
ct_prime12_cor = ct_les12_cor*(V0_Vp12_cor**2)
ct_prime13_cor = ct_les13_cor*(V0_Vp13_cor**2)
ct_prime14_cor = ct_les14_cor*(V0_Vp14_cor**2)
ct_prime15_cor = ct_les15_cor*(V0_Vp15_cor**2)
ct_prime16_cor = ct_les16_cor*(V0_Vp16_cor**2)
ct_prime17_cor = ct_les17_cor*(V0_Vp17_cor**2)
...
plt.scatter(Ctprime_plot[1:16], cp_prime_plot[1:16], color = 'blue', label = 'Unblocked Uncorrected')
plt.scatter(Ctprime_plot[1:16], cp_prime_cor_plot[1:16], color = 'red', label = 'Unblocked Corrected')
plt.scatter(Ctprime_plot[1:16], cp_prime_mblock_plot[1:16], color = 'orange', label = '10 pct Blockage Uncorrected')
...
#Ct
plt.figure(figsize = (9,6))
plt.scatter(Ctprime_plot[1:16], ct_prime_plot[1:16], color = 'blue', label = 'Unblocked Uncorrected')
plt.scatter(Ctprime_plot[1:16], ct_prime_cor_plot[1:16], color = 'red', label = 'Unblocked Corrected')
plt.scatter(Ctprime_plot[1:16], ct_prime_mblock_plot[1:16], color = 'orange', label = '10 pct Blockage Uncorrected')
...
np.save('./ct_prime_mblock_cor_ms', ct_prime_mblock_cor_plot[1:16])
np.save('./cp_prime_hblock_ms', cp_prime_hblock_plot[1:16])
np.save('./ct_prime_hblock_ms', ct_prime_hblock_plot[1:16])
np.save('./cp_prime_hblock_cor_ms', cp_prime_hblock_cor_plot[1:16])
np.save('./ct_prime_hblock_cor_ms', ct_prime_hblock_cor_plot[1:16])
