...
# plt.scatter(Ctprime_plot[1:16], cp_prime_mblock_plot[1:16], label = 'Blocked Unfiltered', color = 'blue')
# plt.scatter(Ctprime_plot[1:16], cp_prime_mblock_cor_plot[1:16], label = 'Blocked Filtered', color = 'orange')
# plt.scatter(Ctprime_plot[1:16], cp_mblock_plot[1:16], label = 'LES Unfiltered', color = 'black', marker = '^')
# plt.scatter(Ctprime_plot[1:16], cp_mblock_cor_plot[1:16], label = 'LES Filtered', color = 'red', marker = '^')
# plt.ylim(-1,1)
# plt.xlabel('Ct Prime')
# plt.ylabel('Equivalent Unblocked Cp')
# plt.title('Emperical Blockage Correction Results (Mikkelsen-Sorensen) at 10% Blockage')
# plt.legend()
# plt.savefig('./cp_prime_ms_mblock')

# plt.figure(figsize = (9,6))
# plt.scatter(Ctprime_plot[1:16], cp_prime_hblock_plot[1:16], label = 'Blocked Unfiltered', color = 'blue')
# plt.scatter(Ctprime_plot[1:16], cp_prime_hblock_cor_plot[1:16], label = 'Blocked Filtered', color = 'orange')
# plt.scatter(Ctprime_plot[1:16], cp_hblock[1:16], label = 'LES Unfiltered', color = 'black', marker = '^')
# plt.scatter(Ctprime_plot[1:16], cp_hblock_cor[1:16], label = 'LES Filtered', color = 'red', marker = '^')
# plt.ylim(-1,1)
# plt.xlabel('Ct Prime')
# plt.ylabel('Equivalent Unblocked Cp')
# plt.title('Emperical Blockage Correction Results (Mikkelsen-Sorensen) at 35% Blockage')
# plt.legend()
# plt.savefig('./cp_prime_ms_hblock')

# #Ct
# plt.figure(figsize = (9,6))
# plt.scatter(Ctprime_plot[1:16], ct_prime_mblock_plot[1:16], label = 'Blocked Unfiltered', color = 'blue')
# plt.scatter(Ctprime_plot[1:16], ct_prime_mblock_cor_plot[1:16], label = 'Blocked Filtered', color = 'orange')
# plt.scatter(Ctprime_plot[1:16], ct_mblock[1:16], label = 'LES Unfiltered', color = 'black', marker = '^')
# plt.scatter(Ctprime_plot[1:16], ct_mblock_cor[1:16], label = 'LES Filtered', color = 'red', marker = '^')
# plt.ylim(-1, 1)
# plt.xlabel('Ct Prime')
# plt.ylabel('Equivalent Unblocked Ct')
# plt.title('Emperical Blockage Correction Results (Mikkelsen-Sorensen) at 10% Blockage')
# plt.legend()
# plt.savefig('./ct_prime_ms_mblock')

# plt.figure(figsize = (9,6))
# plt.scatter(Ctprime_plot[1:16], ct_prime_hblock_plot[1:16], label = 'Corrected Unfiltered', color = 'blue')
# plt.scatter(Ctprime_plot[1:16], ct_prime_hblock_cor_plot[1:16], label = 'Corrected Filtered', color = 'orange')
# plt.scatter(Ctprime_plot[1:16], ct_hblock[1:16], label = 'LES Unfiltered', color = 'black', marker = '^')
# plt.scatter(Ctprime_plot[1:16], ct_hblock_cor[1:16], label = 'LES Filtered', color = 'red', marker = '^')
# plt.ylim(-1, 1)
# plt.xlabel('Ct Prime')
# plt.ylabel('Equivalent Unblocked Ct')
# plt.title('Emperical Blockage Correction Results (Mikkelsen-Sorensen) at 35% Blockage')
# plt.legend()
# plt.savefig('./ct_prime_ms_hblock')
...
print(f"{cp_prime_hblock_cor_plot}")