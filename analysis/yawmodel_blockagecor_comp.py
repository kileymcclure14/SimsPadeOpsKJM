...
cp_yawmodel_n=  np.load('cp_10n_U.npy')
cp_gl = np.load("cp_gl_10_U.npy")
cp_mask = np.load("cp_maskell_10_U.npy")
cp_ms = np.load("Cp_ms_10.npy")
cp_werle = np.load("cp_werle_10.npy")
...
plt.plot(CtPrimes, cp_yawmodel_n, linestyle = '-', color = 'blue', marker = '^', label = 'Yaw Model Correction')
...
plt.savefig('correction_compare_10s_U', bbox_inches='tight', dpi = 300)