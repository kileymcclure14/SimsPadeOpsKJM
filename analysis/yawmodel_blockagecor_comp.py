...
#plt.plot(CtPrimes, cp_test, linestyle = '-', color = 'blue', marker = '^', label = 'Yaw Model Correction')
...
plt.savefig('correction_compare_10_U', bbox_inches='tight', dpi = 300)