...
b3m = ds3m['ubar'].slice(zlim = 2.5, ylim = 0)
b4m = ds4m['ubar'].slice(zlim = 2.5, ylim = 0)
b5m = ds5m['ubar'].slice(zlim = 2.5, ylim = 0)
b6m = ds6m['ubar'].slice(zlim = 2.5, ylim = 0)
b7m = ds7m['ubar'].slice(zlim = 2.5, ylim = 0)
b8m = ds8m['ubar'].slice(zlim = 2.5, ylim = 0)
b9m = ds9m['ubar'].slice(zlim = 2.5, ylim = 0)
b10m = ds10m['ubar'].slice(zlim = 2.5, ylim = 0)
b11m = ds11m['ubar'].slice(zlim = 2.5, ylim = 0)
b12m = ds12m['ubar'].slice(zlim = 2.5, ylim = 0)
b13m = ds13m['ubar'].slice(zlim = 2.5, ylim = 0)
b14m = ds14m['ubar'].slice(zlim = 2.5, ylim = 0)
b15m = ds15m['ubar'].slice(zlim = 2.5, ylim = 0)
b16m = ds16m['ubar'].slice(zlim = 2.5, ylim = 0)
b17m = ds17m['ubar'].slice(zlim = 2.5, ylim = 0)

# b1h = ds1h['ubar'].slice(zlim = 2, ylim = 0)
# b2h = ds2h['ubar'].slice(zlim = 2, ylim = 0)
b3h = ds3h['ubar'].slice(zlim = .75, ylim = 0)
b4h = ds4h['ubar'].slice(zlim = .75, ylim = 0)
b5h = ds5h['ubar'].slice(zlim = .75, ylim = 0)
b6h = ds6h['ubar'].slice(zlim = .75, ylim = 0)
b7h = ds7h['ubar'].slice(zlim = .75, ylim = 0)
b8h = ds8h['ubar'].slice(zlim = .75, ylim = 0)
b9h = ds9h['ubar'].slice(zlim = .75, ylim = 0)
b10h = ds10h['ubar'].slice(zlim = .75, ylim = 0)
b11h = ds11h['ubar'].slice(zlim = .75, ylim = 0)
b12h = ds12h['ubar'].slice(zlim = .75, ylim = 0)
b13h = ds13h['ubar'].slice(zlim = .75, ylim = 0)
b14h = ds14h['ubar'].slice(zlim = .75, ylim = 0)
b15h = ds15h['ubar'].slice(zlim = .75, ylim = 0)
b16h = ds16h['ubar'].slice(zlim = .75, ylim = 0)
b17h = ds17h['ubar'].slice(zlim = .75, ylim = 0)
...
plt.plot(ds3m.x, b3m, label = 'Velocity at Z = 2.5')
plt.legend()
plt.xlabel('x/D')
plt.ylabel('ubar')
...
plt.plot(ds4m.x, b4m, label = 'Velocity at Z = 2.5')
plt.legend()
plt.xlabel('x/D')
plt.ylabel('ubar')
...
plt.plot(ds5m.x, b5m, label = 'Velocity at Z = 2.5')
plt.legend()
plt.xlabel('x/D')
plt.ylabel('ubar')
...
plt.plot(ds6m.x, b6m, label = 'Velocity at Z = 2.5')
plt.legend()
plt.xlabel('x/D')
plt.ylabel('ubar')
...
plt.plot(ds7m.x, b7m, label = 'Velocity at Z = 2.5')
plt.legend()
plt.xlabel('x/D')
plt.ylabel('ubar')
...
plt.plot(ds8m.x, b8m, label = 'Velocity at Z = 2.5')
plt.legend()
plt.xlabel('x/D')
plt.ylabel('ubar')
...
plt.plot(ds9m.x, b9m, label = 'Velocity at Z = 2.5')
plt.legend()
plt.xlabel('x/D')
plt.ylabel('ubar')
...
plt.plot(ds10m.x, b10m, label = 'Velocity at Z = 2.5')
plt.legend()
plt.xlabel('x/D')
plt.ylabel('ubar')
plt.title('Wake and Bypass Velocities at 10% Blockage and Ct Prime = 0.5 ')
...
plt.plot(ds11m.x, b11m, label = 'Velocity at Z = 2.5')
plt.legend()
plt.xlabel('x/D')
plt.ylabel('ubar')
plt.title('Wake and Bypass Velocities at 10% Blockage and Ct Prime = 1 ')
...
plt.plot(ds12m.x, b12m, label = 'Velocity at Z = 2.5')
plt.legend()
plt.xlabel('x/D')
plt.ylabel('ubar')
plt.title('Wake and Bypass Velocities at 10% Blockage and Ct Prime = 1.5 ')
...
plt.plot(ds13m.x, b13m, label = 'Velocity at Z = 2.5')
plt.legend()
plt.xlabel('x/D')
plt.ylabel('ubar')
...
plt.plot(ds14m.x, b14m, label = 'Velocity at Z = 2.5')
plt.legend()
plt.xlabel('x/D')
plt.ylabel('ubar')
plt.title('Wake and Bypass Velocities at 10% Blockage and Ct Prime = 2.5 ')
...
plt.plot(ds15m.x, b15m, label = 'Velocity at Z = 2.5')
plt.legend()
plt.xlabel('x/D')
plt.ylabel('ubar')
plt.title('Wake and Bypass Velocities at 10% Blockage and Ct Prime = 3 ')
...
plt.plot(ds16m.x, b16m, label = 'Velocity at Z = 2.5')
plt.legend()
plt.xlabel('x/D')
plt.ylabel('ubar')
plt.title('Wake and Bypass Velocities at 10% Blockage and Ct Prime = 3.5 ')
...
plt.plot(ds17m.x, b12m, label = 'Velocity at Z = 2.5')
plt.legend()
plt.xlabel('x/D')
plt.ylabel('ubar')
plt.title('Wake and Bypass Velocities at 10% Blockage and Ct Prime = 4 ')
...
plt.plot(ds3h.x, b3h, label = 'Velocity at Z = 0.75')
plt.legend()
plt.xlabel('x/D')
plt.ylabel('ubar')
...
plt.plot(ds4h.x, b4h, label = 'Velocity at Z = 0.75')
plt.legend()
plt.xlabel('x/D')
plt.ylabel('ubar')
...
plt.plot(ds5h.x, b5h, label = 'Velocity at Z = 0.75')
plt.legend()
plt.xlabel('x/D')
plt.ylabel('ubar')
...
plt.plot(ds6h.x, b6h, label = 'Velocity at Z = 0.75')
plt.legend()
plt.xlabel('x/D')
plt.ylabel('ubar')
...
plt.plot(ds7h.x, b7h, label = 'Velocity at Z = 0.75')
plt.legend()
plt.xlabel('x/D')
plt.ylabel('ubar')
...
plt.plot(ds8h.x, b8h, label = 'Velocity at Z = 0.75')
plt.legend()
plt.xlabel('x/D')
plt.ylabel('ubar')
...
plt.plot(ds9h.x, b9h, label = 'Velocity at Z = 0.75')
plt.legend()
plt.xlabel('x/D')
plt.ylabel('ubar')
...
plt.plot(ds10h.x, b10h, label = 'Velocity at Z = 0.75')
plt.legend()
plt.xlabel('x/D')
plt.ylabel('ubar')
plt.title('Wake and Bypass Velocities at 35% Blockage and Ct Prime = 0.5 ')
...
plt.plot(ds11h.x, b11h, label = 'Velocity at Z = 0.75')
plt.legend()
plt.xlabel('x/D')
plt.ylabel('ubar')
plt.title('Wake and Bypass Velocities at 35% Blockage and Ct Prime = 1 ')
...
plt.plot(ds12h.x, b12h, label = 'Velocity at Z = 0.75')
plt.legend()
plt.xlabel('x/D')
plt.ylabel('ubar')
plt.title('Wake and Bypass Velocities at 35% Blockage and Ct Prime = 1.5 ')
...
plt.plot(ds13h.x, b13h, label = 'Velocity at Z = 0.75')
plt.legend()
plt.xlabel('x/D')
plt.ylabel('ubar')
...
plt.plot(ds14h.x, b14h, label = 'Velocity at Z = 0.75')
plt.legend()
plt.xlabel('x/D')
plt.ylabel('ubar')
plt.title('Wake and Bypass Velocities at 35% Blockage and Ct Prime = 2.5 ')
...
plt.plot(ds15h.x, b15h, label = 'Velocity at Z = 0.75')
plt.legend()
plt.xlabel('x/D')
plt.ylabel('ubar')
plt.title('Wake and Bypass Velocities at 35% Blockage and Ct Prime = 3 ')
...
plt.plot(ds16h.x, b16h, label = 'Velocity at Z = 0.75')
plt.legend()
plt.xlabel('x/D')
plt.ylabel('ubar')
plt.title('Wake and Bypass Velocities at 35% Blockage and Ct Prime = 3.5 ')
...
plt.figure(figsize = (9,6))
plt.plot(ds17h.x, c17h, label = 'Centerline Velocity')
plt.plot(ds17h.x, b17h, label = 'Velocity at Z = 0.75')
plt.legend()
plt.xlabel('x/D')
plt.ylabel('ubar')
plt.title('Wake and Bypass Velocities at 35% Blockage and Ct Prime = 4 ')
