...
Cp_time_s1 = power_time_s1 / (0.5 *u_inf1**3)
Cp_time_s1 = Cp_time_s1[50:]
Cp_time_s2 = power_time_s2 / (0.5 * u_inf2**3)
Cp_time_s2 = Cp_time_s2[50:]
Cp_time_s3 = power_time_s3 / (0.5 * u_inf3**3)
...
Cp_t1 = Cp_t1[50:]
plt.figure(figsize = (9,6))
plt.scatter(range(len(Cp_time_s1)), Cp_time_s1, label='Simulated Cp', marker='.', s=5)
...
Cp_t2 = Cp_t2[50:]
plt.figure(figsize = (9,6))
plt.scatter(range(len(Cp_time_s2)), Cp_time_s2, label='Simulated Cp', marker='.', s=5)
...
Cp_t3 = Cp_t3[50:]
plt.figure(figsize = (9,6))
plt.scatter(range(len(Cp_time_s3)), Cp_time_s3, label='Simulated Cp', marker='.', s=5)
...
Cp_t4 = Cp_t4[50:]
plt.figure(figsize = (9,6))
plt.scatter(range(len(Cp_time_s4)), Cp_time_s4, label='Simulated Cp', marker='.', s=5)
...
ct_t2 = ct_t2[50:]
plt.figure(figsize = (9,6))
plt.scatter(range(len(ct_a2)), ct_a2, label = 'Simulated Ct at Ct Prime = 1.50', marker = '.', s = 5)
