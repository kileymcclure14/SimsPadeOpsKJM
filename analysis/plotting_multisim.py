...
#Induction Factores
a1_les = 1-(power_time_s1/(0.5*(np.pi)*Ctprime1))
a1_t = Ctprime1/(4+Ctprime1)
a2_les = 1-(power_time_s2/(0.5*(np.pi)*Ctprime2))
a2_t = Ctprime2/(4+Ctprime2)
a3_les = 1-(power_time_s3/(0.5*(np.pi)*Ctprime3))
a3_t = Ctprime3/(4+Ctprime3)
a4_les = 1-(power_time_s4/(0.5*(np.pi)*Ctprime3))
...
#Cp
min_length_cp1 = min(len(Cp_les_s1),len(Cp_t1))
Cp_les_s1 = Cp_les_s1[:min_length_cp1]
Cp_t1 = Cp_t1[:min_length_cp1]
percent_dif_cp_sim1 = np.abs((Cp_t1 - Cp_time_s1)/Cp_t1)*100
min_length_cp2 = min(len(Cp_les_s2),len(Cp_t2))
Cp_les_s2 = Cp_les_s2[:min_length_cp2]
Cp_t2 = Cp_t2[:min_length_cp2]
percent_dif_cp_sim2 = np.abs((Cp_t2 - Cp_les_s2)/Cp_t2)*100
min_length_cp3 = min(len(Cp_les_s3),len(Cp_t3))
Cp_les_s3 = Cp_les_s3[:min_length_cp3]
Cp_t3 = Cp_t3[:min_length_cp3]
percent_dif_cp_sim3 = np.abs((Cp_t3 - Cp_les_s3)/Cp_t3)*100
min_length_cp4 = min(len(Cp_les_s4),len(Cp_t4))
Cp_les_s4 = Cp_les_s4[:min_length_cp4]
Cp_t4 = Cp_t4[:min_length_cp4]
percent_dif_cp_sim4 = np.abs((Cp_t4 - Cp_les_s4)/Cp_t4)*100
...
#Ct
min_length_ct1 = min(len(ct_les1), len(ct_t1))
ct_les1 = ct_les1[:min_length_ct1]
ct_t1 = ct_t1[:min_length_ct1]
percent_dif_ct_sim1 = np.abs((ct_t1 - ct_les1)/ct_t1)*100
min_length_ct2 = min(len(ct_les2), len(ct_t2))
ct_les2 = ct_les2[:min_length_ct2]
ct_t2 = ct_t2[:min_length_ct2]
percent_dif_ct_sim2 = np.abs((ct_t2 - ct_les2)/ct_t2)*100
min_length_ct3 = min(len(ct_les3), len(ct_t3))
ct_les3 = ct_les3[:min_length_ct3]
ct_t3 = ct_t3[:min_length_ct3]
percent_dif_ct_sim3 = np.abs((ct_t3 - ct_les3)/ct_t3)*100
min_length_ct4 = min(len(ct_les4), len(ct_t4))
ct_les4 = ct_les4[:min_length_ct4]
