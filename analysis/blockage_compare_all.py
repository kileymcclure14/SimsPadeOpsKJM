...
plt.scatter(Ctprime_plot[1:16], a_plot_hblock_cor[1:16], marker = 'o', color = 'brown', label = '35% Blockage, Corrected')
...
plt.scatter(Ctprime_plot[1:16], cp_plot_hblock_cor[1:16], marker = 'o', color = 'brown', label = '35% Blockage, Corrected')
...
plt.scatter(Ctprime_plot[1:16], ct_plot_hblock_cor[1:16], marker = 'o', color = 'brown', label = '35% Blockage, Corrected')
