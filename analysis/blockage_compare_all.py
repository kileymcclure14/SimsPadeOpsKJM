...
#plt.scatter(Ctprime_plot[1:16], a_plot[1:16], marker = 'o', color ='blue', label = 'Unblocked, No Filtering')
plt.scatter(Ctprime_plot[1:16], a_plot_cor[1:16], marker = 'o', color = 'red', label = 'Unblocked, Filtered')
#plt.scatter(Ctprime_plot[1:16], a_plot_mblock[1:16], marker = 'o', color = 'green', label = '10% Blockage, No Filtering')
plt.scatter(Ctprime_plot[1:16], a_plot_mblock_cor[1:16], marker = 'o', color = 'orange', label = '10% Blockage, Filtered')
#plt.scatter(Ctprime_plot[1:16], a_plot_hblock[1:16], marker = 'o', color ='magenta', label = '35% Blockage, No No Filtering')
plt.scatter(Ctprime_plot[1:16], a_plot_hblock_cor[1:16], marker = 'o', color = 'purple', label = '35% Blockage, Filtered')
#plt.plot(Ctprime_plot[1:16], a_t[1:16], color = 'black', label = 'ADM Theory')
plt.title('LES Results Blocked and Unblocked: Induction Factor')
plt.xlabel('Ct Prime')
...
#Cp
plt.figure(figsize = (9,6))
#plt.scatter(Ctprime_plot[1:16], cp_plot[1:16], marker = 'o', color = 'blue', label = 'Unblocked, No Filtering')
plt.scatter(Ctprime_plot[1:16], cp_plot_cor[1:16], marker = 'o', color = 'red', label = 'Unblocked, Filtered')
#plt.scatter(Ctprime_plot[1:16], cp_plot_mblock[1:16], marker = 'o', color = 'green', label = '10% Blockage, No Filtering')
plt.scatter(Ctprime_plot[1:16], cp_plot_mblock_cor[1:16], marker = 'o', color = 'orange', label = '10% Blockage, Filtered')
#plt.scatter(Ctprime_plot[1:16], cp_plot_hblock[1:16], marker = 'o', color = 'magenta', label = '35% Blockage, No Filtering')
plt.scatter(Ctprime_plot[1:16], cp_plot_hblock_cor[1:16], marker = 'o', color = 'purple', label = '35% Blockage, Filtered')
plt.title('LES Results Blocked and Unblocked: Power Coefficient')
plt.xlabel('Ct Prime')
...
#Ct
plt.figure(figsize = (9,6))
#plt.scatter(Ctprime_plot[1:16], ct_plot[1:16], marker = 'o', color = 'blue', label = 'Unblocked, No Filtering')
plt.scatter(Ctprime_plot[1:16], ct_plot_cor[1:16], marker = 'o', color = 'red', label = 'Unblocked, Filtered')
#plt.scatter(Ctprime_plot[1:16], ct_plot_mblock[1:16], marker = 'o', color = 'green', label = '10% Blockage, No Filtering')
plt.scatter(Ctprime_plot[1:16], ct_plot_mblock_cor[1:16], marker = 'o', color = 'orange', label = '10% Blockage, Filtered')
#plt.scatter(Ctprime_plot[1:16], ct_plot_hblock[1:16], marker = 'o', color = 'magenta', label = '35% Blockage, No Filtering')
plt.scatter(Ctprime_plot[1:16], ct_plot_hblock_cor[1:16], marker = 'o', color = 'purple', label = '35% Blockage, Filtered')
plt.title('LES Results Blocked and Unblocked: Thrust Coefficient')
plt.xlabel('Ct Prime')
