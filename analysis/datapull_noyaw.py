...
sim0 = pio.BudgetIO("Data/0_5_0_10_Files", padeops = True, runid = 0, normalize_origin = "turbine")
...
sim1 = pio.BudgetIO("Data/1_0_10_Files", padeops = True, runid = 0, normalize_origin = "turbine")
...
sim2 = pio.BudgetIO("Data/1_5_0_10_Files", padeops = True, runid = 0, normalize_origin = "turbine")
...
sim3 = pio.BudgetIO("Data/2_0_10_Files", padeops = True, runid = 0, normalize_origin = "turbine")
...
sim4 = pio.BudgetIO("Data/2_5_0_10_Files", padeops = True, runid = 0, normalize_origin = "turbine")
...
sim5 = pio.BudgetIO("Data/3_0_10_Files", padeops = True, runid = 0, normalize_origin = "turbine")
...
sim6 = pio.BudgetIO("Data/3_5_0_10_Files", padeops = True, runid = 0, normalize_origin = "turbine")
...
sim7 = pio.BudgetIO("Data/4_0_10_Files", padeops = True, runid = 0, normalize_origin = "turbine")
...
np.save('cp_0deg_10_n.npy', cp_raw)

ct_raw = [ct0, ct1, ct2, ct3, ct4, ct5, ct6, ct7]
np.save('ct_0deg_10_n.npy', ct_raw)