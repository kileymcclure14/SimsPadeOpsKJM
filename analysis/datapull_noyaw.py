...
sim0 = pio.BudgetIO("Data/0_5_10_10_Files", padeops = True, runid = 0, normalize_origin = "turbine")
...
a0 = 1-(ud0/(uinf0*math.cos(math.radians(10))))

sim1 = pio.BudgetIO("Data/1_10_10_Files", padeops = True, runid = 0, normalize_origin = "turbine")
...
a1 = 1-(ud1/(uinf1*math.cos(math.radians(10))))

sim2 = pio.BudgetIO("Data/1_5_10_10_Files", padeops = True, runid = 0, normalize_origin = "turbine")
...
a2 = 1-(ud2/(uinf2*math.cos(math.radians(10))))

sim3 = pio.BudgetIO("Data/2_10_10_Files", padeops = True, runid = 0, normalize_origin = "turbine")
...
a3 = 1-(ud3/(uinf3*math.cos(math.radians(10))))

sim4 = pio.BudgetIO("Data/2_5_10_10_Files", padeops = True, runid = 0, normalize_origin = "turbine")
...
a4 = 1-(ud4/(uinf4*math.cos(math.radians(10))))

sim5 = pio.BudgetIO("Data/3_10_10_Files", padeops = True, runid = 0, normalize_origin = "turbine")
...
a5 = 1-(ud5/(uinf5*math.cos(math.radians(10))))

sim6 = pio.BudgetIO("Data/3_5_10_10_Files", padeops = True, runid = 0, normalize_origin = "turbine")
...
a6 = 1-(ud6/(uinf6*math.cos(math.radians(10))))

sim7 = pio.BudgetIO("Data/4_10_10_Files", padeops = True, runid = 0, normalize_origin = "turbine")
...
a7 = 1-(ud7/(uinf7*math.cos(math.radians(10))))

cp_raw = [cp0, cp1, cp2, cp3, cp4, cp5, cp6, cp7]
np.save('cp_10deg_10.npy', cp_raw)

ct_raw = [ct0, ct1, ct2, ct3, ct4, ct5, ct6, ct7]
np.save('ct_10deg_10.npy', ct_raw)

a_raw = [a0, a1, a2, a3, a4, a5, a6, a7]
np.save('a_10deg_10.npy', a_raw)