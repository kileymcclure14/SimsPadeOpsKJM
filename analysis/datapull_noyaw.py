...
sim0 = pio.BudgetIO("Data/0_5_0_35_Files", padeops = True, runid = 0, normalize_origin = "turbine")
...
sim1 = pio.BudgetIO("Data/1_0_35_Files", padeops = True, runid = 0, normalize_origin = "turbine")
...
sim2 = pio.BudgetIO("Data/1_5_0_35_Files", padeops = True, runid = 0, normalize_origin = "turbine")
...
sim3 = pio.BudgetIO("Data/2_0_35_Files", padeops = True, runid = 0, normalize_origin = "turbine")
...
sim4 = pio.BudgetIO("Data/2_5_0_35_Files", padeops = True, runid = 0, normalize_origin = "turbine")
...
sim5 = pio.BudgetIO("Data/3_0_35_Files", padeops = True, runid = 0, normalize_origin = "turbine")
...
sim6 = pio.BudgetIO("Data/3_5_0_35_Files", padeops = True, runid = 0, normalize_origin = "turbine")
...
sim7 = pio.BudgetIO("Data/4_0_35_Files", padeops = True, runid = 0, normalize_origin = "turbine")
...
np.save('cp_0deg_35.npy', cp_raw)

ct_raw = [ct0, ct1, ct2, ct3, ct4, ct5, ct6, ct7]
np.save('ct_0deg_35.npy', ct_raw)

uinf = [uinf0, uinf1, uinf2, uinf3, uinf4, uinf5, uinf6, uinf7]
np.save('uinf_0deg_35.npy', uinf)

ud = [ud0, ud1, ud2, ud3, ud4, ud5, ud6, ud7]
np.save('ud_0deg_35.npy', ud)
