...
plt.xlabel('Ct Prime')
plt.ylabel('Cp Prime')
plt.title('Emperical Blockage Correction Comparison: 10% Blockage, No Filtering')
...
plt.xlabel('Ct Prime')
plt.ylabel('Cp Prime')
plt.title('Emperical Blockage Correction Comparison: 10% Blockage, With Filtering')
...
plt.scatter(CtPrimes[1:16], cp_prime_hblock_ms[1:16], label = 'Mikkelsen/Sorensen', marker = 'o', color = 'red')
plt.scatter(CtPrimes[1:16], cp_prime_h_ph[1:16], label = 'Pope/Harper', marker = 'o', color = 'green')
plt.legend()
plt.ylim(-1,1)
plt.xlabel('Ct Prime')
plt.ylabel('Cp Prime')
plt.title('Emperical Blockage Correction Comparison: 35% Blockage, No Filtering')
...
plt.scatter(CtPrimes[1:16], cp_prime_hblock_cor_ms[1:16], label = 'Mikkelsen/Sorensen', marker = 'o', color = 'red')
plt.scatter(CtPrimes[1:16], cp_prime_h_cor_ph[1:16], label = 'Pope/Harper', marker = 'o', color = 'green')
plt.legend()
plt.ylim(-1,1)
plt.xlabel('Ct Prime')
plt.ylabel('Cp Prime')
plt.title('Emperical Blockage Correction Comparison: 35% Blockage, With Filtering')
...
plt.scatter(CtPrimes[1:16], ct_prime_hblock_ms[1:16], label = 'Mikkelsen/Sorensen', marker = 'o', color = 'red')
...
plt.scatter(CtPrimes[1:16], ct_prime_hblock_cor_ms[1:16], label = 'Mikkelsen/Sorensen', marker = 'o', color = 'red')
